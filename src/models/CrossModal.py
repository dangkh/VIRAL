...
class CrossmodalNet(nn.Module):
    def __init__(self, inchannels) -> None:
        ...
        self.vt_trans = TransformerEncoder(inchannels, num_heads= 2, layers=1)
        self.vt_self = TransformerEncoder(inchannels, num_heads= 2, layers=1)

        self.tv_trans = TransformerEncoder(inchannels, num_heads= 2, layers=1)
        self.tv_self = TransformerEncoder(inchannels, num_heads= 2, layers=1)
